...
* **d2tf** - convert a number, representing microseconds since the epoch, to printable format using the conventions of strftime, plus %xf for fractional seconds, where x represents number of digits from 0 to 6.
* **tf2d** - convert printable time format to a number, representing microseconds since the epoch. 
